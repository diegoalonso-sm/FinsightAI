...
class NewsExtractor:
    ...
    @staticmethod
    async def extract_content(crawler, urls: List[str], model: str, sample_html: str, llm_query: str) -> List[dict]:
...
class YahooFinanceNewsExtractor(NewsExtractor):
    ...
    async def run(self) -> List[dict]:
        ...
        async with AsyncWebCrawler(config=browser_config) as crawler:
            ...
            extracted_data = await self.extract_content(crawler=crawler, urls=urls, model=self.model, sample_html=self.sample_html, llm_query=self.llm_query)
